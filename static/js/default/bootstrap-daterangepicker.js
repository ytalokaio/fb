(function(root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' + '<div class="calendar first left"></div>' + '<div class="calendar second right"></div>' + '<div class="ranges">' + '<div class="range_inputs">' + '<div class="daterangepicker_start_input form-group form-group-default ">' + '<label for="daterangepicker_start"></label>' + 


         '<input class="form-control" type="text" name="daterangepicker_start" value="" id="' + this.startId  + '" />' + 
         '</div>' + '<div class="daterangepicker_end_input form-group form-group-default ">' + 
         '<label for="daterangepicker_end"></label>' + 
         '<input class="form-control" type="text" name="daterangepicker_end" value="" id="' + this.endId  + '" />' + 
         '</div>' + '<button class="applyBtn" disabled="disabled"></button>&nbsp;' + '<button class="cancelBtn"></button>' + '</div>' + '</div>' + '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            /** ----  **/
            if (typeof options.endId === 'string') 
                this.endId = options.endId;
            if (typeof options.startId === 'string') 
            ...
            if (typeof options.startId !== 'undefined' && typeof options.endId !== 'undefined') {
                this.container.find('input[name="daterangepicker_start"]').attr('id', options.startId);
                this.container.find('input[name="daterangepicker_end"]').attr('id', options.endId);
            }
